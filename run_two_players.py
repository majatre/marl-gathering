...
NAME = f"DQNvsDDQN-lr{learning_rate()}-dr{discount_rate()}-bs{batch_size()}-{current_time}"
...
for e in range(EPISODES):
    ...
    for time in range(1000): 
        ...
        reward1, reward2 = env.move(action1, action2)
        ...
        agent2.store(state, action2, reward2, nstate, done)
